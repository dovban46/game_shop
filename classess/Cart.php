...
public function getCartProduct(){
	...
	if ($updated_row) {
		header("Location:cart.php");
			...
			$msg = "<span class='error'>Кількість не оновлено</span>";
				return $msg;
	}
	}
...
$msg = "<span class='error'>Гру не видалено</span>";
	...
	$updated_row = $this->db->update($query);
	if ($updated_row) {
		$msg = "<span class='success'>Оновлено</span>";
				return $msg;
	} else{
			$msg = "<span class='error'>Не оновлено</span>";
				return $msg;
	}
	...
	public function delProductShifted($id){
	    ...
	    $deldata = $this->db->delete($query);
	    if ($deldata) {
		$msg = "<span class='success'>Дані успішно видалено</span>";
				return $msg;
	}else{
$msg = "<span class='error'>Дані не видалено</span>";
				return $msg;
