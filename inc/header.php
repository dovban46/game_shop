			  ...
			  <div class="header_top_right">
			    <div class="search_box">
				    <form action="search.php" method="get">
				    	<input type="text" value="Введіть гру" name="search" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Search for Products';}">
...
<?php }else{ ?>
<a href="?cid=<?php Session::get('cmrId') ?>">Вихід</a>
<?php }
?>
		   </div>
		 <div class="clear"></div>
...
<div class="menu" id="myHeader">
	...
	<div class="topnav" id="myTopnav">
	  ...
	  <a href="topbrands.php">Бібліотека</a>
<?php 
...
if ($chkOrder) { ?>
 <a href="orderdetails.php">Замовлення</a>
<?php } ?>
